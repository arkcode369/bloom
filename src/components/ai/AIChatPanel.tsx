/**
 * AIChatPanel Component — Phase 8: AI Chat / Q&A over Notes
 * Path: src/components/ai/AIChatPanel.tsx
 * 
 * Sliding panel from sidebar. Full chat interface with RAG.
 * Shows note references as clickable source links.
 * Session management: new chat, history, delete.
 */
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
            ...
            <p className="text-xs mt-1">
              I'll search your knowledge base to give contextual answers.
            </p>
          </div>
        )}
                ...
                {msg.noteRefs.length > 0 && !msg.isStreaming && (
                  <div className="mt-2 pt-2 border-t border-border/30">
                    ...
                    <div className="flex flex-wrap gap-1">
                      ...
                      {msg.noteRefs.length > 5 && (
                        <span className="text-[10px] text-muted-foreground px-1">
                          +{msg.noteRefs.length - 5} more
                        </span>
                      )}
                    </div>
                  </div>
